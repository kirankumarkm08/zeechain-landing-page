        ...
        {Blog.map((blog, index) => (
          ...
          >
            <Image
              ...
              width={350}
              height={200}
              className="rounded-xl mt-2 border border-lightgray"
            />
            <h2 className="font-medium text-white-600 text-24 leading-32  font-clash">
              {blog.label}
            </h2>
            ...
            <div className="flex justify-between w-full">
              <p className="font-normal text-white-700">February 8, 2025</p>
              <Link
                href={blog.link}
